...
export function SalesBarChart() {
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle className="text-slate-900 dark:text-white">Sales (Costs + Margin)</CardTitle>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={chartData}>
            ...
            <Legend />
            <Bar dataKey="costs" fill={COLORS.costs} name="Costs" stackId="stack" />
            <Bar dataKey="margin" fill={COLORS.margin} name="Margin" stackId="stack" />
          </BarChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
